...
static XUartPs Uart_PS; /* Instance of the UART */
static XUartPs_Config *Config; /* Pointer to UART configuration data */
...
int main(void) {
	...
	ctrls = &(ctrls){&AxiDma, CfgPtr, &Intc, IntcConfig, &UartPs, Cfg};
